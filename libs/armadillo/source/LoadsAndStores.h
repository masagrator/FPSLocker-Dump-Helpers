...
static const char *unscaled_instr_tbl[] __attribute__((unused)) = {
    "sturb",
    "ldurb",
    "ldursb",
    "ldursb",
...
static const char *pre_post_unsigned_register_idx_instr_tbl[] __attribute__((unused)) = {
    "strb",
    "ldrb",
    "ldrsb",
    "ldrsb",
...
static const char *unprivileged_instr_tbl[] __attribute__((unused)) = {
    "sttrb",
    "ldtrb",
    "ldtrsb",
    "ldtrsb",
